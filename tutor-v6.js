(() => {
  ...
  function openSubject(subjectName){
    ...
    lessonArea.innerHTML=''; topActions.forEach(a=>a.disabled=false);
    subjectHome();
    panel.scrollIntoView({behavior:'smooth',block:'start'});
  }

  // Event delegation: makes every current/future subject card respond reliably.
  ...
  // Tiny debug hook so the page can confirm the fresh tutor engine is loaded.
  window.DURRA_TUTOR={version:'6.0',openSubject};
